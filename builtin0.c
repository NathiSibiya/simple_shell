...
/**
 * shellby_exit - process normal termination
 * @args: array of arguments for exit value
 * @front: double pointer to beginning of args
 *
 * Return: -3 for no arguments,invalid exit value 2, else exit
 */
 ...
 * @front: double pointer to beginning of args
 *
 * Return: if string is not a directory 2, error -1, else 0
 */
...
/**
 * shellby_help - displays info about builtin commands
 * @args: array of arguments
