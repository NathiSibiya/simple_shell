...
/**
 * help_all - displays all builtin commands
 */
...
/**
 * help_alias - info on alias command
 */
...
void help_alias(void)
{
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "th format NAME='VALUE'. \n\talias name [nam2 ...]: prints";
	write(STDOUT_FILENO, msg, _strlen(msg));
...
void help_cd(void)
{
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " process to DIRCTORY.\n\n\tIf no argument is given, the ";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "command is interpreted as cd $HOME. If the argument '-' is";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " given, the comman is interpreted as cd $OLDPWD.\n\n";
	write(STDOUT_FILENO, msg, _strlen(msg));
...
/**
 * help_exit - info about exit command
 */
...
void help_exit(void)
{
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " If no argument given, the command is interpreted as";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " exit 0.\n";
	write(STDOUT_FILENO, msg, _strlen(msg));
}
...
/**
 * help_help - info on help command
 */
