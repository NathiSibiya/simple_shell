...
/**
 * get_env_value - brings the value corresponding to an environment variable.
 * @beginning:is the environmental variable to search for.
 * @len: is the length of the environmental variable to search for.
 *
 * Return: when the variable is not found - an empty string.
...
/**
 * variable_replacement - this handles variable replacement.
