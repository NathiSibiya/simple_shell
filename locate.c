 ...
 *
 * Return: when an error occurs or the command cannot be located - NULL.
...
/**
 * get_path_dir - Tokenize a colon-separated list of
 *                directories into a list_s linked list.
 * @path: This is a colon-separated list of directories.
 *
 * Return: it's a pointer to the initialized linked list.
 */
list_t *get_path_dir(char *path)
{
	int index;
