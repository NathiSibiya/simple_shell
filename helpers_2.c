 ...
 * @line: this is a  pointer to a line read from standard input.
 ...
 *
 * Return: this is the new length of the line.
 *
 ...
 * @line: this is a pointer to the character to check in the line.
 * @new_len:this is a Pointer to new_len in get_new_len function.
 */
void logical_ops(char *line, ssize_t *new_len)
{
	char previous, current, next;
